...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	define("CENTINEL_PROCESSOR_ID", $this->processor_id);
    define("CENTINEL_MERCHANT_ID", $this->merchant_id);
	define("CENTINEL_TRANSACTION_PWD", $this->transaction_password);
	define("CENTINEL_MAPS_URL", "https://centineltest.cardinalcommerce.com/maps/txns.asp");

	define("CENTINEL_TERM_URL", "ccAuthenticate.php");
	
    define("CENTINEL_NOTIFY_URL", "ccNotify.php");
